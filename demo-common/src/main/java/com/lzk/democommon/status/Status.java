package com.lzk.democommon.status;
...
public enum Status {
    ...
    PARAMEXCEPTION(-2, "参数有误"),
    EXCEPTION(-3, "网络异常"),
    REQUEST_METHOD_ERROE(-4,"请求方法不匹配"),
    LOGINSUCCESS(10, "登录成功"),
    LOGIN_FAIL_CAUSE_PWD(11, "登录失败，用户名或密码错误"),
    ...
    LOGINPASSWORDERROR(16, "密码错误"),
    LOGINUSERNAMENOTDOUND(17, "用户不存在"),
    LOGIN_FAIL_CAUSE_CODE_INVALID(18, "登录失败，验证码失效"),
